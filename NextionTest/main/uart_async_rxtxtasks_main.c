...
static void tx_task()
{
    ...
    while (1) {
		...
		sendData(TX_TASK_TAG, "page 0");
        sendData(TX_TASK_TAG, "ref t0");
        sendData(TX_TASK_TAG, "page0.t0.txt=\"Saludos Nextion, desde ESP32\"ÿÿÿ");		//example text value - Outside temp
        sendData(TX_TASK_TAG, "page 0");
        sendData(TX_TASK_TAG, "ref t0");
